...
import {SimpleKeyboard, Hangul2Keyboard, Hangul3Keyboard} from './keyboards'
import {NonHangulPenaltyScorer, Hangul2350Scorer, HangulSyllableFrequencyScorer} from './scorers'

export default class Mfsjea {
    static LAYOUTS = {
